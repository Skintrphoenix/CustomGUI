...
class DoubleChest2
{
    ...
    public function openDoubleChest2(Player $sender){
    	if ($this->plugin->getConfig()->get("doublechest2", true)) {
           ...
           $inventory->setItem(11, Item::get($this->doublechest2c->get("id12"), $this->doublechest2c->get("meta12"), $this->doublechest2c->get("count12"))->setCustomName($this->doublechest2c->get("itemsname14"))->setLore([$this->doublechest2c->get("desc14")]));
