...
class DoubleChest
{
    ...
    public function openDoubleChest(Player $sender){
    	if ($this->plugin->getConfig()->get("doublechest", true)) {
           ...
           $inventory->setItem(11, Item::get($this->doublechestc->get("id12"), $this->doublechestc->get("meta12"), $this->doublechestc->get("count12"))->setCustomName($this->doublechestc->get("itemsname14"))->setLore([$this->doublechestc->get("desc14")]));
