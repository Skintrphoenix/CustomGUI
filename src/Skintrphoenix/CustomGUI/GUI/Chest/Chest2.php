...
class Chest2
{
    ...
    public function openChest2(Player $sender){
		if ($this->plugin->getConfig()->get("chest2", true)) {
           ...
           $inventory->setItem(11, Item::get($this->chest2c->get("id12"), $this->chest2c->get("meta12"), $this->chest2c->get("count12"))->setCustomName($this->chest2c->get("itemsname12"))->setLore([$this->chest2c->get("desc12")]));
