...
class Chest
{
    ...
    public function openChest(Player $sender){
		if ($this->plugin->getConfig()->get("chest", true)) {
           ...
           $inventory->setItem(11, Item::get($this->chestc->get("id12"), $this->chestc->get("meta12"), $this->chestc->get("count12"))->setCustomName($this->chestc->get("itemsname14"))->setLore([$this->chestc->get("desc14")]));
